...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-10rem)] items-center justify-center p-4 md:w-1/2 ">
      <Card className="w-full max-w-lg glass shadow-2xl border-t-white/20">
        ...
        <CardContent className="space-y-6">
          {error && (
            <p className="text-sm text-destructive bg-destructive/10 p-3 rounded-lg text-center font-medium">
              {error}
            </p>
          )}
        ...
        <CardFooter className="flex flex-col gap-3 pt-2">
          <Button
            size="lg"
            className="w-full text-lg shadow-lg hover:shadow-primary/20"
